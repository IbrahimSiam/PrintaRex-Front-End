...
const WomensSportTShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 102.75,
    priceEGP: 882.19,
    description: 'Performance sport T-shirt with moisture-wicking technology. Perfect for active women who need comfort and performance during workouts.',
    ...
    features: [
      'Moisture-wicking Fabric', 'Performance fit', 'Breathable material',
      'Easy to customize', 'Multiple color options', 'Active lifestyle design'
    ],
                      ...
                      {product.colors.map((color) => (
                        <Avatar
                          ...
                          sx={{
                            ...
                            color: ['white', 'yellow', 'blue', 'purple'].includes(color.toLowerCase()) ? '#333' : '#fff',
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This performance sport T-shirt is engineered for active women who demand both comfort and functionality. 
                  The advanced moisture-wicking technology keeps you dry and comfortable during intense workouts, while the 
                  breathable fabric ensures optimal airflow. The athletic fit provides freedom of movement without restriction, 
                  making it perfect for running, yoga, gym sessions, or any high-energy activity.
                </Typography>
              </TabPanel>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fabric:</strong> Moisture-wicking Performance Blend
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Weight:</strong> 140 GSM
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fit:</strong> Athletic/Performance
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensSportTShirt;
