...
const WomensComfortHoodie: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 139.45,
    priceEGP: 1197.69,
    description: 'Ultra-comfortable hoodie with soft fabric and relaxed fit. Perfect for everyday comfort and casual wear.',
    ...
    features: [
      'Ultra-soft Fabric', 'Relaxed fit', 'Comfortable design',
                      ...
                      {product.colors.map((color) => (
                        <Avatar
                          ...
                          sx={{
                            ...
                            color: ['white', 'yellow', 'gray'].includes(color.toLowerCase()) ? '#333' : '#fff',
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This ultra-comfortable hoodie is designed with your comfort in mind. The soft, breathable fabric 
                  provides a gentle touch against your skin, while the relaxed fit ensures freedom of movement throughout the day. 
                  Perfect for lounging at home, running errands, or any casual activity where comfort is key.
                </Typography>
              </TabPanel>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fabric:</strong> Ultra-soft Cotton Blend
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Weight:</strong> 250 GSM
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fit:</strong> Relaxed/Comfortable
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensComfortHoodie;
