...
const PoloShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 128.45,
    priceEGP: 1102.69,
    description: 'Classic polo shirt with a sophisticated collar and professional appearance. Perfect for business casual and smart casual occasions.',
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        ...
                        <Typography variant="body2" fontWeight={500}>Premium Pique Cotton</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        <Typography variant="body2" color="text.secondary">Weight</Typography>
                        <Typography variant="body2" fontWeight={500}>200 GSM</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        <Typography variant="body2" color="text.secondary">Fit</Typography>
                        <Typography variant="body2" fontWeight={500}>Classic Fit</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
