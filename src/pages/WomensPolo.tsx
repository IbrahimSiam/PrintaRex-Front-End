...
const WomensPolo: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 128.45,
    priceEGP: 1102.69,
    description: 'Classic polo shirt with a sophisticated collar and professional appearance. Perfect for business casual and elegant occasions.',
    ...
    features: [
      '100% Premium Cotton', 'Classic polo collar', 'Professional fit',
      'Easy to customize', 'Multiple color options', 'Business casual style'
    ],
          ...
          <Box sx={{ mt: 6 }}>
            <Card>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" paragraph>
                  This classic polo shirt is designed for the professional woman who values both style and sophistication. 
                  Made from premium cotton fabric, it features a distinctive polo collar that adds a refined touch to any 
                  outfit. Perfect for business casual settings, meetings, or elegant social occasions.
                </Typography>
              </TabPanel>
