...
const OversizeTShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 110.05,
    priceEGP: 945.19,
    description: 'Trendy oversize T-shirt with a relaxed fit and modern streetwear aesthetic. Perfect for contemporary fashion and urban style.',
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        ...
                        <Typography variant="body2" fontWeight={500}>160 GSM</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        <Typography variant="body2" color="text.secondary">Fit</Typography>
                        <Typography variant="body2" fontWeight={500}>Oversize Fit</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        <Typography variant="body2" color="text.secondary">Style</Typography>
                        <Typography variant="body2" fontWeight={500}>Streetwear</Typography>
                      </Box>
                    </Box>
                  </Grid>
                  <Grid item xs={12} md={6}>
