...
const SlimFitTShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 99.05,
    priceEGP: 850.69,
    description: 'Modern slim fit T-shirt with a tailored silhouette and stretch fabric. Perfect for a contemporary, fitted look.',
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                      ...
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        ...
                        <Typography variant="body2" fontWeight={500}>175 GSM</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        <Typography variant="body2" color="text.secondary">Fit</Typography>
                        <Typography variant="body2" fontWeight={500}>Slim Fit</Typography>
                      </Box>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', py: 1, borderBottom: '1px solid #f3f4f6' }}>
                        <Typography variant="body2" color="text.secondary">Style</Typography>
                        <Typography variant="body2" fontWeight={500}>Modern Tailored</Typography>
                      </Box>
                    </Box>
                  </Grid>
                  <Grid item xs={12} md={6}>
