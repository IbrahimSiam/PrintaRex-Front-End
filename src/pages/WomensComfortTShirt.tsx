...
const WomensComfortTShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 91.75,
    priceEGP: 787.69,
    description: 'Ultra-comfortable T-shirt with soft fabric and relaxed fit. Perfect for everyday comfort and casual wear.',
    ...
    features: [
      'Ultra-soft Cotton', 'Relaxed fit', 'Comfortable fabric',
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This ultra-comfortable T-shirt is designed with your comfort in mind. The soft, breathable fabric 
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fabric:</strong> Ultra-soft Cotton
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Weight:</strong> 150 GSM
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensComfortTShirt;
