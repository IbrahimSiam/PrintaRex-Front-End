...
const WomensPremiumTShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 128.45,
    priceEGP: 1102.69,
    description: 'Premium quality T-shirt with luxurious fabric and elegant design. Perfect for sophisticated women who appreciate quality and style.',
    ...
    features: [
      'Luxurious Cotton Blend', 'Elegant fit', 'Premium fabric',
      'Easy to customize', 'Multiple color options', 'Sophisticated design'
    ],
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This premium T-shirt represents the pinnacle of quality and sophistication. Crafted from the finest 
                  cotton blend fabric, it offers an unparalleled level of comfort and elegance. The refined fit and 
...
export default WomensPremiumTShirt;
