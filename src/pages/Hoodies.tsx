...
const Hoodies: React.FC = () => {
  ...
  const hoodieProducts = [
    ...
    },
    {
      ...
      priceAED: 293.45,
      priceEGP: 2519.69,
      description: 'Eco-friendly hoodie made from 100% organic cotton. Sustainable and comfortable for conscious consumers.',
    ...
    {
      id: 6,
      name: 'Luxury Cashmere Blend Hoodie',
      image: '/assets/img/hoodie.jpg',
      priceUSD: 129.99,
      priceAED: 476.86,
      priceEGP: 4094.69,
      ...
      <Box sx={{ flex: 1, ml: { xs: 0, md: sidebarOpen ? `${getSidebarWidth()}px` : 0 }, transition: 'margin-left 0.3s ease-in-out' }}>
        ...
        <Container maxWidth="xl" sx={{ py: 6 }}>
          ...
          <Breadcrumbs sx={{ mb: 4, '& .MuiBreadcrumbs-ol': { alignItems: 'center' } }}>
            ...
            <Typography variant="body2" color="text.primary" sx={{ fontWeight: 500 }}>Hoodies</Typography>
          </Breadcrumbs>
          ...
          <Box sx={{ mb: 6 }}>
            ...
            <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 400, color: '#6b7280' }}>
              Explore our premium collection of customizable hoodies for comfort and style
            </Typography>
          </Box>
              ...
              <Grid item xs={12} sm={6} md={4} key={product.id}>
                ...
                >
                  <Box sx={{ height: 250, overflow: 'hidden' }}>
                    <img
                      src={product.image}
                      alt={`${product.name} - customizable hoodie`}
                      style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover'
