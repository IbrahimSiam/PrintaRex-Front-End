...
const WomensFashionHoodie: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 165.15,
    priceEGP: 1417.69,
    description: 'Trendy fashion hoodie with modern styling and premium materials. Perfect for fashion-forward women who want to make a statement.',
    ...
    features: [
      'Premium Materials', 'Modern styling', 'Trendy design',
      'Easy to customize', 'Multiple color options', 'Fashion-forward look'
    ],
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This trendy fashion hoodie is designed for the modern woman who wants to express her unique style. 
                  The contemporary design and premium materials provide both comfort and sophistication, while the 
                  fashionable fit ensures you look stylish in any setting. Perfect for casual outings, social events, 
                  or everyday wear where you want to make a fashion statement.
                </Typography>
              </TabPanel>
              <TabPanel value={tabValue} index={1}>
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fit:</strong> Modern/Fashionable
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensFashionHoodie;
