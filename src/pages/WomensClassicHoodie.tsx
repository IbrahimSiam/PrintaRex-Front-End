...
const WomensClassicHoodie: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 146.76,
    priceEGP: 1259.69,
    description: 'Classic women\'s hoodie with a comfortable fit and warm fleece lining. Perfect for everyday comfort and casual wear.',
    ...
    features: [
      'Warm Fleece Lining', 'Comfortable fit', 'Soft fabric',
                      ...
                      {product.colors.map((color) => (
                        <Avatar
                          ...
                          sx={{
                            ...
                            color: ['white', 'yellow', 'gray', 'pink'].includes(color.toLowerCase()) ? '#333' : '#fff',
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This classic women's hoodie is designed for everyday comfort and warmth. The soft fleece lining 
                  provides excellent insulation while maintaining breathability, making it perfect for cooler weather. 
                  The comfortable fit ensures ease of movement, while the durable fabric ensures long-lasting wear. 
                  Ideal for casual outings, lounging at home, or layering under jackets during colder months.
                </Typography>
              </TabPanel>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fabric:</strong> Cotton Blend with Fleece Lining
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Weight:</strong> 280 GSM
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fit:</strong> Classic/Comfortable
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensClassicHoodie;
