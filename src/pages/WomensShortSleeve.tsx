...
const WomensShortSleeve: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 99.05,
    priceEGP: 850.69,
    description: 'Classic short sleeve T-shirt with a flattering fit and premium cotton fabric. Perfect for everyday wear and custom designs.',
    ...
    features: [
      '100% Premium Cotton', 'Classic fit', 'Breathable fabric',
          ...
          <Box sx={{ mt: 6 }}>
            <Card>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" paragraph>
                  This classic short sleeve T-shirt is designed for the everyday woman who values comfort and style. 
                  Made from premium cotton fabric, it offers a flattering fit that's perfect for daily wear. The 
                  versatile design makes it easy to pair with any outfit while maintaining a professional appearance.
                </Typography>
              </TabPanel>
...
export default WomensShortSleeve;
