...
const KidsHoodies: React.FC = () => {
  ...
  // Sample Kids' Hoodie products data
  const hoodieProducts = [
    {
      ...
      priceAED: 256.86,
      priceEGP: 2204.69,
      description: 'Warm and cozy kids\' hoodie for custom designs with soft cotton fabric.',
    ...
    },
    {
      ...
      priceAED: 275.05,
      priceEGP: 2362.19,
      description: 'Active kids\' hoodie perfect for sports designs and outdoor activities.',
    ...
    {
      id: 3,
      name: 'Kids\' Fashion Hoodie',
      image: '/assets/img/hoodie.jpg',
      priceUSD: 79.99,
      priceAED: 293.45,
      priceEGP: 2519.69,
      description: 'Stylish kids\' hoodie with trendy designs and comfortable fit.',
    ...
    },
    {
      ...
      priceAED: 330.26,
      priceEGP: 2834.69,
      description: 'Eco-friendly hoodie made from 100% organic cotton for conscious families.',
    ...
    },
    {
      ...
      priceAED: 311.71,
      priceEGP: 2677.19,
      description: 'Fun character-themed hoodie perfect for kids with vibrant designs.',
      colors: ['White', 'Black', 'Blue', 'Red'],
      sizes: ['XS', 'S', 'M', 'L'],
      technology: ['DTG', 'DTF', 'Screen Printing'],
      inStock: true,
    ...
    },
    {
      ...
      priceAED: 348.45,
      priceEGP: 2992.19,
      description: 'Premium quality hoodie for kids with extra soft fabric and durability.',
      ...
      <Box sx={{ flex: 1, ml: { xs: 0, md: sidebarOpen ? `${getSidebarWidth()}px` : 0 }, transition: 'margin-left 0.3s ease-in-out' }}>
        ...
        <Container maxWidth="xl" sx={{ py: 6 }}>
          ...
          <Breadcrumbs sx={{ mb: 4, '& .MuiBreadcrumbs-ol': { alignItems: 'center' } }}>
            ...
            <Typography variant="body2" color="text.primary" sx={{ fontWeight: 500 }}>Kids' Hoodies</Typography>
          </Breadcrumbs>
          ...
          <Box sx={{ mb: 6 }}>
            <Typography variant="h3" component="h1" sx={{ fontWeight: 800, fontSize: { xs: '2rem', md: '2.5rem' }, background: 'linear-gradient(135deg, #1e293b 0%, #475569 100%)', backgroundClip: 'text', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', letterSpacing: '-0.025em', mb: 2 }}>
              Kids' Hoodies Collection
            </Typography>
            <Typography variant="h6" color="text.secondary" sx={{ fontWeight: 400, color: '#6b7280' }}>
              Explore our warm and comfortable collection of customizable hoodies for kids
            </Typography>
          </Box>
              ...
              <Grid item xs={12} sm={6} md={4} key={product.id}>
                ...
                >
                  <Box sx={{ height: 250, overflow: 'hidden' }}>
                    <img
                      src={product.image}
                      alt={`${product.name} - customizable kids' hoodie`}
                      style={{
                        width: '100%',
                        height: '100%',
                        objectFit: 'cover'
