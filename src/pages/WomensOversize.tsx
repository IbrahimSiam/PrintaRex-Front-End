...
const WomensOversize: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 110.05,
    priceEGP: 945.19,
    description: 'Trendy oversize T-shirt with a relaxed fit and modern streetwear aesthetic. Perfect for fashion-forward looks and comfortable styling.',
    ...
    features: [
      '100% Premium Cotton', 'Oversize fit', 'Relaxed silhouette',
      'Easy to customize', 'Multiple color options', 'Modern streetwear style'
    ],
          ...
          <Box sx={{ mt: 6 }}>
            <Card>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" paragraph>
                  This trendy oversize T-shirt is designed for the fashion-forward woman who loves to make a statement. 
                  Made from premium cotton fabric, it offers a relaxed, comfortable fit that's perfect for casual 
                  outings and streetwear styling. The oversize silhouette adds a modern, edgy touch to any outfit.
                </Typography>
              </TabPanel>
