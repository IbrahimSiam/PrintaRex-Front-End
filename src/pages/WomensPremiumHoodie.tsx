...
const WomensPremiumHoodie: React.FC = () => {
  ...
  const [mainImage, setMainImage] = useState('/assets/img/hoodie.jpg');
  ...
  const product = {
    ...
    priceAED: 183.45,
    priceEGP: 1574.69,
    description: 'Premium quality hoodie with luxurious fabric and elegant design. Perfect for sophisticated women who appreciate quality and style.',
    ...
    features: [
      'Luxurious Fabric', 'Elegant design', 'Premium quality',
      'Easy to customize', 'Multiple color options', 'Sophisticated look'
    ],
      ...
      <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <Box sx={{ p: 2, bgcolor: '#fff', borderBottom: '1px solid #e0e0e0' }}>
          <Breadcrumbs aria-label="breadcrumb">
            ...
            <Link color="inherit" href="/app/womens-hoodies" underline="hover">
              Women's Hoodies
            </Link>
                      ...
                      {product.colors.map((color) => (
                        <Avatar
                          ...
                          sx={{
                            ...
                            color: ['white', 'yellow', 'ivory', 'navy'].includes(color.toLowerCase()) ? '#333' : '#fff',
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This premium hoodie represents the pinnacle of quality and sophistication. Crafted from the finest 
                  materials, it offers an unparalleled level of comfort and elegance. The refined design and 
                  luxurious feel make it perfect for both casual and semi-formal occasions, while the superior fabric 
                  ensures your custom designs look exceptional and last for years to come.
                </Typography>
              </TabPanel>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fabric:</strong> Luxurious Cotton Blend
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Weight:</strong> 350 GSM
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fit:</strong> Elegant/Refined
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensPremiumHoodie;
