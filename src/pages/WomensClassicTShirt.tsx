...
const WomensClassicTShirt: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 99.05,
    priceEGP: 850.69,
    description: 'Classic women\'s T-shirt with a flattering fit and premium cotton fabric. Perfect for everyday wear and custom designs.',
    colors: ['White', 'Black', 'Pink', 'Lavender'],
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    technology: ['DTG', 'DTF'],
    inStock: true,
    tags: ['classic', 'flattering', 'versatile'],
    features: [
      '100% Premium Cotton', 'Flattering fit', 'Breathable fabric',
      'Easy to customize', 'Multiple color options', 'Various size availability'
    ],
                      ...
                      {product.colors.map((color) => (
                        <Avatar
                          ...
                          sx={{
                            ...
                            color: ['white', 'yellow', 'pink', 'lavender'].includes(color.toLowerCase()) ? '#333' : '#fff',
            ...
            <Paper elevation={2} sx={{ borderRadius: '16px' }}>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" sx={{ mt: 2, lineHeight: 1.8 }}>
                  This classic women's T-shirt is crafted from premium cotton fabric, offering exceptional comfort and breathability. 
                  The flattering fit is designed to complement various body types, making it perfect for everyday wear. 
                  The fabric is easy to customize with various printing technologies, ensuring your designs look vibrant and last long.
                </Typography>
              </TabPanel>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fabric:</strong> 100% Premium Cotton
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body2" sx={{ mb: 1 }}>
                      <strong>Fit:</strong> Classic/Regular
                    </Typography>
                    <Typography variant="body2" sx={{ mb: 1 }}>
...
export default WomensClassicTShirt;
