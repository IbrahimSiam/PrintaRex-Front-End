...
const WomensSlimFit: React.FC = () => {
  ...
  const product = {
    ...
    priceAED: 99.05,
    priceEGP: 850.69,
    description: 'Modern slim fit T-shirt with a tailored silhouette and stretch fabric. Perfect for a sleek, contemporary look.',
    ...
    features: [
      'Premium Stretch Fabric', 'Modern slim fit', 'Tailored silhouette',
      'Easy to customize', 'Multiple color options', 'Contemporary style'
    ],
          ...
          <Box sx={{ mt: 6 }}>
            <Card>
              ...
              <TabPanel value={tabValue} index={0}>
                ...
                <Typography variant="body1" paragraph>
                  This modern slim fit T-shirt is designed for the contemporary woman who appreciates a sleek, 
                  tailored appearance. Made from premium stretch fabric, it offers a flattering silhouette that 
                  hugs the body in all the right places while maintaining comfort and flexibility.
                </Typography>
              </TabPanel>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      ...
                      <Typography variant="body2">Premium Stretch Fabric</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography variant="body2">Fit:</Typography>
                      <Typography variant="body2">Slim Fit</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
